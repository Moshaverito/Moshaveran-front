  ...
  const termsData = [
    {
      ...
      items: [
        {
          term: "مشاوریتو",
          definition: "بستر آنلاین ارائه خدمات روانشناسی و روان‌درمانی",
        },
        {
          term: "درمانگر",
          definition:
            "روانشناس یا روان‌درمانگر دارای مجوز رسمی که از طریق پلتفرم به ارائه خدمات مشاوره می‌پردازد",
        },
        { term: "درمانجو", definition: "فرد دریافت‌کننده خدمات درمانی" },
        {
          term: "جلسه مشاوره",
          definition:
            "هرگونه ارتباط متنی، صوتی یا تصویری که از طریق پلتفرم برقرار می‌شود",
        },
        {
          term: "حساب کاربری",
          definition: "فضای اختصاصی درمانجو برای مدیریت نوبت‌ها و خدمات",
        },
        {
          term: "کیف پول مشاوریتو",
          definition:
            "فضای مالی مجازی برای واریز، برداشت و مدیریت اعتبار کاربران",
        },
        {
          term: "اعتبار",
          definition: "مبلغ شارژشده توسط درمانجو در حساب کاربری خود",
        },
      ],
    },
    {
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-white/70 backdrop-blur-md rounded-2xl p-8 shadow-lg mb-8">
            ...
            <p className="text-gray-600 leading-relaxed text-lg">
              با ثبت‌نام و استفاده از خدمات «مشاوریتو»، شما به عنوان درمانجو،
              متعهد به رعایت قوانین زیر خواهید بود. هدف از این قوانین، تضمین
              کیفیت خدمات، حفظ حریم خصوصی، امنیت روانی و اخلاقی طرفین است.
            </p>
            ...
            {termsData.map((section) => (
              ...
              >
                <button
                  ...
                  className="w-full p-6 text-right flex items-center justify-between hover:bg-white/50 transition-all bg-white/70"
                >
                  <div className="flex items-center gap-4">
                    <div
                      className={`w-12 h-12 bg-gradient-to-r ${section.color} rounded-xl flex items-center justify-center text-white`}
                    >
                      {section.icon}
                    </div>
                    <div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white/70 backdrop-blur-md rounded-2xl p-8 shadow-lg text-center">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              در صورت بروز هرگونه اختلاف یا نارضایتی از خدمات درمانگر، لطفاً از
              طریق بخش پشتیبانی با ما تماس بگیرید. موارد تخصصی نیز در صورت لزوم
              به سازمان نظام روانشناسی و مشاوره جمهوری اسلامی ایران ارجاع داده
              خواهند شد.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="border-2 border-teal-500 text-teal-600 hover:bg-teal-50 px-8 py-3 rounded-xl font-medium transition-all flex items-center justify-center gap-2 bg-inherit">
