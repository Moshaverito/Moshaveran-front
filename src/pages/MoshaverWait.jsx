  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch(
        "https://api.moshaveritoo.ir/api/accounts/Mregister/register_moshaver_from_waitlist/",
        {
          method: "POST",
          headers: {
        ...
        <div className="max-w-md w-full">
          <div className="bg-white/70 backdrop-blur-md rounded-2xl shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              اطلاعات شما در لیست انتظار قرار گرفت. به زودی با شما تماس خواهیم
              گرفت.
            </p>
            <button
      ...
      <div className="max-w-md w-full">
        ...
        {step === 2 && (
          <div className="bg-white/70 backdrop-blur-md rounded-2xl shadow-lg p-6 sm:p-8">
            ...
            <button
              onClick={() => setStep(1)}
              className="flex items-center text-teal-600 hover:text-teal-700 mb-7 transition-colors bg-inherit"
            >
            ...
            <div className="bg-gradient-to-r from-teal-500 to-blue-500 text-white rounded-lg p-3 mb-6 text-center">
              <span className="font-bold">
                {
                  counselorTypes.find((t) => t.value === formData.counselorType)
                    ?.label
                }
              </span>
            </div>
            ...
            <div className="space-y-6">
              ...
              {(formData.counselorType === "therapist" ||
                formData.counselorType === "couple") && (
                <div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      rows="4"
                      className="w-full pr-12 pl-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-300 resize-none bg-gray-50 placeholder:text-gray-400 text-gray-900"
                    />
                    <div className="absolute right-3 top-3 text-gray-400">
            ...
            <div className="flex items-start">
              ...
              <div className="mr-3">
                <p className="text-sm text-blue-800">
                  <strong>توجه:</strong> لطفاً تمامی اطلاعات را به دقت تکمیل
                  کنید. پس از بررسی مدارک، تیم ما با شما تماس خواهد گرفت.
                </p>
              </div>
            </div>
          </div>
