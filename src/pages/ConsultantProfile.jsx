...
import { User, FileText, GraduationCap, Award, Image, Video, Mic, Save, CheckCircle, AlertCircle, Upload } from 'lucide-react';
          ...
          <div className="bg-white/70 backdrop-blur-md rounded-2xl shadow-lg p-4 mb-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <div className={`w-3 h-3 rounded-full mr-3 ${profileData.is_verified ? 'bg-green-500' : 'bg-yellow-500'}`}></div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                rows="6"
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-300 resize-none"
              />
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  onChange={handleInputChange}
                  className="w-full pr-12 pl-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-300 appearance-none"
                >
